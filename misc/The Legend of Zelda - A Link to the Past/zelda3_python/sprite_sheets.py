...
def draw_string3x5(dst, dst_pitch, dx, dy, s, color):
  # No-op ici -- ne sert qu'a etiqueter des images de debug (jamais lues
  # par la compilation finale de zelda3_assets.dat, voir compile_resources.py
  # ligne 102 : sprsheet reste None sauf --sprites-from-png, non utilise
  # ici), pas la peine de distribuer 3x5_font.png pour ca.
  pass
