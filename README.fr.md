...
- Bouton **Change version** dans le panneau Info — choisis parmi les dernières releases GitHub/GitLab et installe-en une autre que la dernière, utile quand la version la plus récente laisse tomber une plateforme dont tu as besoin (ex: un build Windows) ; sert aussi à forcer une mise à jour immédiatement plutôt que d'attendre le prochain Play
