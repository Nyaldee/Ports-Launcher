...
/// Timeout unique et généreux pour un appel d'API (GitHub/GitLab) -- seul un
/// blocage réellement anormal (connexion qui ne répond jamais) doit être
/// coupé, un délai large sur un appel API n'a pas d'effet observable.
