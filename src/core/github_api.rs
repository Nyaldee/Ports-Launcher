...
/// Même forme que l'erreur de sélection d'asset (voir asset_select.rs) --
/// GitHub/GitLab ne distinguent chacun aucun cas d'erreur qui leur soit
/// propre, un simple alias partagé évite trois enums identiques.
