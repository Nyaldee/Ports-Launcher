...
/// d'obtenir ce HWND depuis l'API publique de Slint. Même nom que
/// `linux_chrome::native_window` (type de retour natif différent selon
/// l'OS) pour que main.rs appelle un seul nom via l'alias `chrome`.
