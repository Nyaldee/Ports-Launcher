...
/// Lance l'updater (`ports_launcher_updater.bat`/`.sh`, à côté de l'exe, voir
/// base_dir) puis ferme l'appli -- l'updater tue le process par sécurité au
/// cas où, mais une fermeture propre ici ne dépend pas uniquement de ce kill
/// forcé. Efface `launcher_update_available` (et redémarre son délai) juste
/// avant de relancer -- le tout nouveau build qui redémarre ensuite n'a plus
/// de raison de croire qu'une MAJ l'attend encore, voir le commentaire du
/// champ.
